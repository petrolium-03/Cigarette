...
export const BADGES = [
  {
    ...
    name: "Honest Mirror",
    blurb: (m) =>
      `You logged your first ${m.singularNoun}. Awareness beats denial — every quit story starts with looking honestly at the habit.`,
  ...
  },
  {
    ...
    name: "Eagle Lung",
    blurb: (m) =>
      `50 ${m.pluralNoun} your lungs never had to deal with. Every skipped one is a real win.`,
  ...
  },
  {
    ...
    name: "Mythical Zero",
    blurb: (m) =>
      `A whole day without a single ${m.singularNoun}. Rare, magical, and proof that you can do it again tomorrow.`,
...
export function blurbText(badge, mode) {
  return typeof badge.blurb === "function" ? badge.blurb(mode) : badge.blurb;
}
